                ...
                <ul class="navbar-nav">
                    ...
                    <li>
                        <a href="./Profile-submit.php" class="nav-link px-3 active">
                            <span class="me-2">
                                <i class="bi bi-person-check fs-4" style="color:rgb(59, 185, 97);"></i>
                            </span>
                            <span style="color:rgb(59, 185, 97);">تکمیل پروفایل </span>
                        </a>
                    </li>
                    <li class="">
                        <hr />
                ...
                <div class="row d-flex p-3">
                    ...
                    <div class="col-12">
                        <div class="form-floating mb-3">
                            ...
                            <div class="invalid-feedback">
                                شماره تماس صحیح نیست!مثال : [09xxxxxxxxx]
                            </div>
                        </div>
