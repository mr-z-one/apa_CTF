...
$template = '        <div class="col col-xs-12  col-md-3 py-3 ">
                ...
                return sprintf($template,$img_src,$name,$id_modal,$is_active);
}


function create_challenge_modal_card(string $id_modal,string $description,string $challenge_id){
    $template = '
        <div class="modal fade " id="%s" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                    ...
                    <div class="modal-body">
                        ...
                        <div class="tab-content text-white" id="myTabContent">
                            ...
                            <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel"
                                ...
                                <form action="/profile/flag-submit.php?id=%s" method="post">
                            ...
                            <div class="tab-pane fade" id="writeup" role="tabpanel" aria-labelledby="profile-tab"
                                tabindex="0">
                                <form action="/profile/upload_writeup.php?id=%s" method="post">
                                    <div class="mb-3">
